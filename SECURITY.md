...
<!-- TODO - PGP Key: [download from our keyserver](https://keys.21ooo.ooo/security.asc)
- Key fingerprint: `KEY` -->
...
- Email: security@21ooo.ooo
<!-- TODO - PGP Klíč: [stáhnout z našeho keyserveru](https://keys.21ooo.ooo/security.asc)
- Otisky klíče: `KEY` -->
