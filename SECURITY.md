...
2. **Zašlete email** na adresu security@21-000-000.org s předmětem "BEZPEČNOSTNÍ ZRANITELNOST: [stručný popis]".
...
- Email: security@21-000-000.org
- PGP Klíč: [stáhnout z našeho keyserveru](https://keys.21-000-000.org/security.asc)
...
2. **Send an email** to security@21-000-000.org with the subject "SECURITY VULNERABILITY: [brief description]".
...
- Email: security@21-000-000.org
- PGP Key: [download from our keyserver](https://keys.21-000-000.org/security.asc)
